...
public class UserDetails {
    ...
    public int getShareMantraCount() {
        return shareMantraCount;
    }

    public void setShareMantraCount(int shareMantraCount) {
        this.shareMantraCount = shareMantraCount;
    }

    public int getMyMantraCount() {
        return myMantraCount;
    }

    public void setMyMantraCount(int myMantraCount) {
        this.myMantraCount = myMantraCount;
    }
