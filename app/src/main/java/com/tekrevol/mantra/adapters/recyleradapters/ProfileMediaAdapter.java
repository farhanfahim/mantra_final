 ...
 *
 */
public class ProfileMediaAdapter extends PagingAdapter {
    ...
    public ProfileMediaAdapter(Context activity, List<MediaModel> arrData, FragmentName titleName, OnItemClickListener onItemClickListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        itemView = LayoutInflater.from(activity)
                .inflate(R.layout.customlist_list_delete, parent, false);
