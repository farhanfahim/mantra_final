 ...
 *
 */
public class SearchAdapter extends PagingAdapter {
    private final OnItemClickListener onItemClick;

    private Context activity;
    private List<MediaModel> arrData;

    public SearchAdapter(Context activity, List<MediaModel> arrData, OnItemClickListener onItemClickListener) {
...
/*
    ...
    public void setArrData(List<MediaModel> arrData) {
        this.arrData = arrData;
    }
